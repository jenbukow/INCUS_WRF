...
#PBS -V
#PBS -q smd_ops
#PBS -lselect=40:ncpus=128:mpiprocs=128:model=rom_ait,walltime=72:00:00
#PBS -W group_list=s2841
#PBS -j oe
#PBS -o wrf_mpt_30s_inir.log
#PBS -e wrf_error_30s_init.log
#PBS -N SIO1.1_WT_30s_INIT
#PBS -m be
#PBS -r n
...
mpiexec -np 5120 ./wrf.exe >& wrf.exe.out_SIO1.1_WT-30s_INIT
