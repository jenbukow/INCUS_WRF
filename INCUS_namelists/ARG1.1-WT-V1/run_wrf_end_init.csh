...
#PBS -V
#PBS -q smd_ops
#PBS -lselect=150:ncpus=28:mpiprocs=28:model=bro,walltime=48:00:00
#PBS -W group_list=s2841
#PBS -j oe
#PBS -o wrf_mpt_end_init.log
#PBS -e wrf_error_end_init.log
#PBS -N ARG1.1_WT_END_INIT 
#PBS -m be
#PBS -r n
...
#mpiexec -np 2304 ./wrf.exe >& wrf.exe.out_ARG1.1_WT_INIT
mpiexec -np 4200 ./wrf.exe >& wrf.exe.out_ARG1.1_WT_G3_END_INIT
