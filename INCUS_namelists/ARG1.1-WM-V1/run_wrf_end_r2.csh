...
#PBS -V
#PBS -q smd_ops
#PBS -lselect=35:ncpus=128:mpiprocs=128:model=rom_ait,walltime=8:00:00
#PBS -W group_list=s2841
#PBS -j oe
#PBS -o wrf_mpt_end_r2_init.log
#PBS -e wrf_error_end_r2_init.log
#PBS -N ARG1.1_WM_END_R2
#PBS -m be
#PBS -r n
...
mpiexec -np 4480 ./wrf.exe >& wrf.exe.out_ARG1.1_WM_END_R2
