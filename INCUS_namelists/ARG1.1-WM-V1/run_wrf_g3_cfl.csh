...
#PBS -V
#PBS -q smd_ops
#PBS -lselect=160:ncpus=28:mpiprocs=28:model=bro,walltime=60:00:00
#PBS -W group_list=s2841
#PBS -j oe
#PBS -o wrf_mpt_g3_cfl_dt.log
#PBS -e wrf_error_g3_cfl_dt.log
#PBS -N ARG1.1_WM_G3_CFL_dt
#PBS -m be
#PBS -r n
...
mpiexec -np 4480 ./wrf.exe >& wrf.exe.out_ARG1.1_WM_G3_CFL_dt
