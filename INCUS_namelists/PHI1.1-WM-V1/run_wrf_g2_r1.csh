...
#PBS -V
#PBS -q smd_ops
#PBS -lselect=84:ncpus=28:mpiprocs=28:model=bro,walltime=48:00:00
#PBS -W group_list=s2841
#PBS -j oe
#PBS -o wrf_mpt_g2_r1.log
#PBS -e wrf_error_g2_r1.log
#PBS -N PHI1.1_WM_G2_R1.exe
#PBS -m be
#PBS -r n
...
mpiexec -np 2352 ./wrf.exe >& wrf.exe.out_PHI1.1_morr_g2_r1
