...
#PBS -V
#PBS -q smd_ops
#PBS -lselect=150:ncpus=28:mpiprocs=28:model=bro,walltime=24:00:00
#PBS -W group_list=s2841
#PBS -j oe
#PBS -o wrf_mpt_g3_30s_r3.log
#PBS -e wrf_error_g3_30s_r3.log
#PBS -N ARG1.2_WT_G3_30s_R3
#PBS -m be
#PBS -r n
...
mpiexec -np 4200 ./wrf.exe >& wrf.exe.out_ARG1.2_WT_G3_30s_R3
