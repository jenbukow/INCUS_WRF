...
#PBS -V
#PBS -q smd_ops
#PBS -lselect=18:ncpus=128:mpiprocs=128:model=rom_ait,walltime=72:00:00
#PBS -W group_list=s2841
#PBS -j oe
#PBS -o wrf_mpt_30s_init.log
#PBS -e wrf_error_30s_init.log
#PBS -N PHI2.1_WM_30s_init
#PBS -m be
#PBS -r n
...
#mpiexec -np 2352 ./wrf.exe >& wrf.exe.out_PHI2.1_WM-INIT
mpiexec -np 2304 ./wrf.exe >& wrf.exe.out_PHI2.1-WM-30s-INIT
